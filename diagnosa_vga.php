...
$("div.btn-input").live('click', function(){
    ...
    btn.addClass('active btn-primary');
		...
		//tampilkan pertanyaan pertama
			$sqlp = "SELECT * FROM diagnosa_vga where mulai='Y'";
		...
		echo "<form>";
			echo "<legend>Diagnosa Kerusakan Video Adapter (VGA) </legend>";
			echo "<center>";
		...
		//tampilkan pertanyaan pertama
			...
			$sqlp = "select * from diagnosa_vga where id=$idsolusi";
		...
		echo "<form>";
			...
			<center><p><strong>TUGAS AKHIR : </strong><br>
